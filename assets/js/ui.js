class Interfaz {
    ...
    <div class="col-lg-4">
        <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
            <h3>Precio de la cripto: ${datosMoneda.FROMSYMBOL},</h3>
            <h3>a moneda: ${datosMoneda.TOSYMBOL}</h3>
        </div>
    </div>
        ...
        <div class="col-lg-4">
            <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                    <h3>Es de:</h3>
                    <h3 class="m-auto">$ ${precio}</h3>
            </div> 
        </div>
        
        <div class="col-lg-4">
            <div class="mx-auto features-icons-item mb-5 mb-lg-0 mb-lg-3">
                <h3>Porcentaje de variación: ${porcentaje}%</h3>
                <h3>Desde el: ${actualizado}</h3>
            </div>
        </div>
    </div>`
